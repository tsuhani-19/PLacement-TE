...
const barcMaterials = [
  { title: "Official Website", link: "https://barc.gov.in" },
  { title: "Previous Year Papers", link: "https://barc.gov.in/careers" },
  { title: "Mock Tests", link: "https://testseries.barc.gov.in/" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg mb-12">
          ...
          <ul className="list-disc pl-5 text-indigo-900">
            ...
            <li>Focus on nuclear physics, engineering, and technical subjects.</li>
            <li>Improve accuracy with mock tests and time management.</li>
            <li>Stay updated with BARC’s latest research projects.</li>
          </ul>
        </div>

        {/* Swiper for Important Dates */}
        <div className="w-full max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-indigo-300 mb-6">BARC 2025 Important Dates</h2>
          <Swiper
